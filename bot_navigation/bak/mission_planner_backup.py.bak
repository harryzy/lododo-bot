...
class MissionPlanner(Node):
    ...
    def __init__(self):
        ...
        self._waypoint_recorder_save_client = self.create_client(
            WaypointControl, '/waypoint_recorder/save_waypoints'
        )
        self._waypoint_recorder_load_client = self.create_client(
            WaypointControl, '/waypoint_recorder/load_waypoints'
        )
        self._waypoint_recorder_record_client = self.create_client(
            Trigger, '/waypoint_recorder/record_current'
        )
        self._waypoint_recorder_start_client = self.create_client(
            Trigger, '/waypoint_recorder/start_recording'
        )
        self._waypoint_recorder_stop_client = self.create_client(
            Trigger, '/waypoint_recorder/stop_recording'
        )
        self._waypoint_recorder_clear_client = self.create_client(
    ...
    def _handle_waypoint_control(self, request, response):
        ...
        try:
            ...
            if action == 'save':
                # 保存路点到文件
                if not self._waypoint_recorder_save_client.wait_for_service(timeout_sec=2.0):
                    response.success = False
                ...
                future = self._waypoint_recorder_save_client.call_async(req)
                ...
                # 从文件加载路点
                if not self._waypoint_recorder_load_client.wait_for_service(timeout_sec=2.0):
                    response.success = False
                    response.message = "WaypointRecorder service not available"
                    response.waypoint_count = 0
                    return response
                ...
                req.action = 'load'
                req.filename = request.filename
                future = self._waypoint_recorder_load_client.call_async(req)
                rclpy.spin_until_future_complete(self, future, timeout_sec=5.0)
                ...
                # 清空所有路点
                if not self._waypoint_recorder_clear_client.wait_for_service(timeout_sec=2.0):
                    response.success = False
                    response.message = "WaypointRecorder service not available"
                    response.waypoint_count = 0
                    return response
                ...
                req = Trigger.Request()
                future = self._waypoint_recorder_clear_client.call_async(req)
                rclpy.spin_until_future_complete(self, future, timeout_sec=5.0)
            ...
            self.get_logger().info(f"Waypoint control action: {action}, result: {response.message}")
    ...
    def _handle_record_waypoints(self, request, response):
        ...
        try:
            ...
            if action == 'start':
                # 开始自动录制
                if not self._waypoint_recorder_start_client.wait_for_service(timeout_sec=2.0):
                    response.success = False
                    response.message = "WaypointRecorder service not available"
                ...
                req = Trigger.Request()
                future = self._waypoint_recorder_start_client.call_async(req)
                rclpy.spin_until_future_complete(self, future, timeout_sec=5.0)
                ...
                # 停止录制
                if not self._waypoint_recorder_stop_client.wait_for_service(timeout_sec=2.0):
                    response.success = False
                    response.message = "WaypointRecorder service not available"
                    response.recorded_count = 0
                    return response
                ...
                req = Trigger.Request()
                future = self._waypoint_recorder_stop_client.call_async(req)
                rclpy.spin_until_future_complete(self, future, timeout_sec=5.0)
                ...
                # 录制当前位置
                if not self._waypoint_recorder_record_client.wait_for_service(timeout_sec=2.0):
                    response.success = False
                    response.message = "WaypointRecorder service not available"
                    response.recorded_count = 0
                    return response
                ...
                req = Trigger.Request()
                future = self._waypoint_recorder_record_client.call_async(req)
                rclpy.spin_until_future_complete(self, future, timeout_sec=5.0)
            ...
            self.get_logger().info(f"Record waypoints action: {action}, result: {response.message}")
